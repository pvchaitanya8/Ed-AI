...
from UI_functions.profile_pic import get_base64_image
...
logo_url = r"static files\Ed AI logo.png"
profile_pic_url = r"static files\profile pic.png"

col1, col2, col3, col4 = st.columns([0.7, 7, 3, 0.5])
...
if selected == "Learn":
    st.title("Learn")
    st.write("This is the content of Learn.")
